...
<table>
	<tr>
		<th>名前</th><td><input type="text" id="friend_name" class="len10" value=""></input></td>
  </tr>
	<tr>
		<th>最後に会った日</th><td><input type="text" id="friend_last_meeting" class="len10" value="<?php echo date('Y-m-d'); ?>"></td>
  </tr>
	<tr>
